...
#| fig-align: center
#| fig-cap: "This formalisation of uncertainty visualisation offers extensive flexibility, illustrated by six plots: line, pie chart, histogram, map, bubble chart, and network diagram. These plots are made with almost identical syntax with `ggdibbler` as that in the deterministic `ggplot2` equivalent. These aesthetics - position, colour, size, slope - are all mapped using random variables."
#| fig-height: 6
#| fig-width: 9
#| out-width: 100%
