...
tab <- tribble(
  ...
  3, "A Mathematical Framework and Software Implementation for Uncertainty Visualisation", "Prepared for submission to Journal of Computational of Computational and Graphical Statistics", "Concept, writing, software design and implementation", "Dianne Cook, (help): ??%; Sarah Goodwin, (help): ??%; Susan Vanderplas, (help): ??%", "No",
   "Colour Blinded by the Noise", "Submitted to IEEE VIS 2026", "Concept, experiment design and implementation, writing", "Dianne Cook, (help): ??%; Rachel Rogers, (help): ??%; Alison Kleffner, (help): ??%", "No"
)
```
